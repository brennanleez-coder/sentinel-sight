...
class HashResult(Enum):
    ...
    DIFF_PSACHP="Rank 3 - DIFF: Permissions, Same: App Cert Hash, App Hash"
    DIFF_ACHAHSP="Rank 4 - DIFF: App Cert Hash, App Hash, Same: Permissions"
    DIFF_PAHSACH="Rank 5 - DIFF: Permissions, App Hash, Same: App Cert Hash"
    DIFF_PACHSAH="Rank 6 - DIFF: Permissions, App Cert Hash, Same: App Hash"
    DIFF_AHPSACH="Rank 7 - DIFF: Permissions, App Hash, Same: App Cert Hash"
    DIFF_ACHPAH="Rank 8 - DIFF: App Cert Hash, App Hash, Permissions"
...
def determine_apk_legitimacy(incoming_apk_hash, downloaded_apk_hash, incoming_app_cert_hash, downloaded_app_cert_hash, incoming_permissions, downloaded_permissions):
    ...
    if is_same_app_hash and is_same_app_cert_hash and is_same_permissions:
        ...
        return HashResult.DIFF_PSACHP.value
